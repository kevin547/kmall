package com.jjsj.mall.pass.controller;
...
public class OnePassController {
    ...
    public CommonResult<Object> sendUserCode(@RequestParam(name = "phone") String phone,
    ...
    public CommonResult<String> register(
        @Validated @RequestBody OnePassRegisterRequest registerRequest) {
    ...
    public CommonResult<Map<String, Object>> account(
        @Validated @RequestBody OnePassLoginRequest request) {
    ...
    public CommonResult<JSONObject> updatePassword(
        @Validated @RequestBody OnePassUpdateRequest request) {
    ...
    public CommonResult<JSONObject> updatePhone(
        @Validated @RequestBody OnePassLoginRequest request) {
    ...
    public CommonResult<JSONObject> serviceOpen(
        @RequestBody @Validated ServiceOpenRequest request) {

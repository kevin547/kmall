package com.jjsj.mall.statistics.service.impl;
...
import com.jjsj.mall.statistics.response.HomeRateResponse;
import com.jjsj.mall.statistics.service.HomeService;
...
public class HomeServiceImpl implements HomeService {
    ...
    public HomeRateResponse sales() {
        ...
        //日同比
        BigDecimal dayRate = MallUtil.getRateBig(today, yesterday);

        //周同比
        BigDecimal weekRate = MallUtil.getRateBig(week, preWeek);

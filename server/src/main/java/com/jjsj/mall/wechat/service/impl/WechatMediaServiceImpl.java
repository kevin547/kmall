...
import com.jjsj.utils.UploadWeChatMediaUtil;
import com.jjsj.mall.wechat.service.WeChatService;
import com.jjsj.mall.wechat.service.WechatMediaService;
import lombok.Data;
...
//                throw new MallException("素材图片上传失败, 没有从微信服务器上找到相关信息2");
//            }
//
//            Map<String, String> map = new HashMap<>();

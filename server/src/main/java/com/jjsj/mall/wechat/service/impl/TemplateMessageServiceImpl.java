...
import com.jjsj.mall.wechat.vo.SendTemplateMessageItemVo;
...
import com.jjsj.mall.wechat.dao.TemplateMessageDao;
    ...
    */
    ...
    public TemplateMessage infoException(Integer id) {
        ...
        if(null == templateMessage){
            throw new MallException("此模板" + id + " 不存在或者已删除");
        }

        if(templateMessage.getStatus().equals(0)){
            throw new MallException("此模板未启用");
        }

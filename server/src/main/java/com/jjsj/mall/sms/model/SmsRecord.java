package com.jjsj.mall.sms.model;
...
public class SmsRecord implements Serializable {
    ...
    public SmsRecord(String uid, String phone, String content, String addIp, String template,
        Integer resultcode, Integer recordId, String message) {
        this.uid = uid;
        this.phone = phone;

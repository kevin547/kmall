package com.jjsj.mall.sms.controller;
...
public class SmsRecordController {
    ...
    public CommonResult<JSONObject> modifySign(
        @RequestBody @Validated SmsModifySignRequest request) {
    ...
    public CommonResult<Map<String, Object>> temps(
    ...
    public CommonResult<JSONObject> applyTempMessage(
        @RequestBody @Validated SmsApplyTempRequest request) {
    ...
    public CommonResult<Map<String, Object>> applys(

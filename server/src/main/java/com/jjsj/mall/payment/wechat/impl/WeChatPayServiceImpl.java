package com.jjsj.mall.payment.wechat.impl;
...
import com.jjsj.mall.payment.vo.wechat.CreateOrderH5SceneInfoDetailVo;
import com.jjsj.mall.payment.vo.wechat.CreateOrderH5SceneInfoVo;
import com.jjsj.mall.payment.vo.wechat.CreateOrderRequestVo;
...
public class WeChatPayServiceImpl implements WeChatPayService {
    ...
    private void createOrderWeChatData(){
        ...
        getCreateOrderRequestVo().setNonce_str(DigestUtils.md5Hex(
        ...
        getCreateOrderRequestVo().setSign(
            MallUtil.getSign(MallUtil.objectToMap(getCreateOrderRequestVo()), getSignKey()));
    }

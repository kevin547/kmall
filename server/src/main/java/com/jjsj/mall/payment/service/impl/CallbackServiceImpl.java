...
import com.jjsj.mall.payment.service.CallbackService;
...
import com.jjsj.mall.payment.vo.wechat.CallbackVo;
...
//            HashMap<String, Object> map = XmlUtil.xmlToMap(xmlInfo);
            ...
            //解析xml
            CallbackVo callbackVo = MallUtil.mapToObj(map, CallbackVo.class);
...
//                //用户信息错误
//                throw new MallException("用户信息错误！");
//            }
            ...
            if (!Constants.SERVICE_PAY_TYPE_ORDER.equals(attachVo.getType()) && !Constants.SERVICE_PAY_TYPE_RECHARGE.equals(attachVo.getType())) {
                ...
                throw new MallException("未知的支付类型！");
            }
            // 订单
            if (Constants.SERVICE_PAY_TYPE_ORDER.equals(attachVo.getType())) {
                ...
                if (ObjectUtil.isNull(storeOrder)) {
                    ...
                    throw new MallException("wechat pay error : 订单信息不存在==》" + callbackVo.getOutTradeNo());
                }
            ...
            if (Constants.SERVICE_PAY_TYPE_RECHARGE.equals(attachVo.getType())) {
                ...
                if (!rechargePayAfter) {
                    ...
                    throw new MallException("wechat pay error : 数据保存失败==》" + callbackVo.getOutTradeNo());
                }
            }
            sb.append("<return_code><![CDATA[SUCCESS]]></return_code>");
            sb.append("<return_msg><![CDATA[OK]]></return_msg>");

...
public interface UserBrokerageRecordService extends IService<UserBrokerageRecord> {
     ...
     */
    PageInfo<SpreadCommissionDetailResponse> findDetailListByUid(Integer uid,
     ...
     * @return PageInfo
     */
    PageInfo<UserBrokerageRecord> getFundsMonitorDetail(Integer uid, String dateLimit,
        PageParamRequest pageParamRequest);

...
public interface UserService extends IService<User> {
    ...
    List<UserSpreadPeopleItemResponse> getSpreadPeopleList(List<Integer> userIdList,
        String keywords, String sortKey, String isAsc, PageParamRequest pageParamRequest);
    ...
    PageInfo<User> getUserListBySpreadLevel(RetailShopStairUserRequest request,
        PageParamRequest pageParamRequest);

    PageInfo<StoreOrder> getOrderListBySpreadLevel(RetailShopStairUserRequest request,
        PageParamRequest pageParamRequest);
     ...
     */
    Boolean operationBrokerage(Integer uid, BigDecimal price, BigDecimal brokeragePrice,
        String type);
     ...
     */
    PageInfo<User> getAdminSpreadPeopleList(String storeBrokerageStatus, String keywords,

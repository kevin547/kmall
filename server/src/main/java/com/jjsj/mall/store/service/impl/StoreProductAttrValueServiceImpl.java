...
import com.jjsj.mall.store.dao.StoreProductAttrValueDao;
import com.jjsj.mall.store.model.StoreProductAttrValue;
import com.jjsj.mall.store.request.StoreProductAttrValueSearchRequest;
...
public class StoreProductAttrValueServiceImpl extends ServiceImpl<StoreProductAttrValueDao, StoreProductAttrValue>
    ...
    */
    ...
    public boolean decProductAttrStock(Integer productId, Integer attrValueId, Integer num, Integer type) {
        ...
        if(existAttrValues.size() == 0) throw new MallException("商品不存在");

...
import com.jjsj.mall.store.request.StoreProductReplyCommentRequest;
import com.jjsj.mall.store.request.StoreProductReplyRequest;
...
public class StoreProductReplyController {
   ...
   public CommonResult<String> comment(@RequestBody StoreProductReplyCommentRequest request){
        List<Integer> ids = MallUtil.stringToArray(request.getIds());
       for (Integer id : ids) {

...
import com.jjsj.mall.system.dao.SystemCityDao;
...
import com.jjsj.mall.system.service.SystemCityAsyncService;
...
public class SystemCityServiceImpl extends ServiceImpl<SystemCityDao, SystemCity> implements SystemCityService {
    ...
    public String getStringNameInId(String cityIdList) {
        ...
        lambdaQueryWrapper.in(SystemCity::getCityId, MallUtil.stringToArray(cityIdList));

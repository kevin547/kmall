...
import com.jjsj.constants.SysConfigConstants;
import com.jjsj.constants.SysGroupDataConstants;
...
import com.jjsj.mall.system.response.SystemAdminResponse;
import com.jjsj.mall.system.response.SystemGroupDataAdminLoginBannerResponse;
import com.jjsj.mall.validatecode.model.ValidateCode;
import com.jjsj.mall.validatecode.service.ValidateCodeService;
...
import com.jjsj.mall.system.dao.SystemAdminDao;
import com.jjsj.mall.system.model.SystemAdmin;
import com.jjsj.mall.system.model.SystemRole;
import com.jjsj.mall.system.request.SystemAdminAddRequest;
import com.jjsj.mall.system.request.SystemAdminLoginRequest;
import com.jjsj.mall.system.request.SystemAdminRequest;
...
import com.jjsj.mall.system.service.SystemRoleService;
...
//        lambdaQueryWrapper.setEntity(systemAdmin);
    ...
    public SystemAdminResponse login(SystemAdminLoginRequest systemAdminLoginRequest, String ip) throws Exception {
        ...
        // base64加密获取真正密码
        String encryptPassword = MallUtil
            .encryptPassword(systemAdminLoginRequest.getPwd(), systemAdminLoginRequest.getAccount());
...
//        systemAdminRequest.setAccount(tokenModel.getUserNo());
    ...
    public SystemAdminResponse weChatAuthorizeLogin(String code, String ip) throws Exception {
        ...
        if(null == userToken){
            throw new MallException("当前微信账号没有绑定后台账户，请用账号密码登录之后在个人中心扫码绑定");
        }
